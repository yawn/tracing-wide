```console
$ cargo run -q --example catalogue-facet --features catalogue,facet
---
messages: 
  request completed: 
    ...
    meta: 
      owner: api
    origin: "tracing-wide tracing-wide/examples/catalogue-facet.rs:16:8"
    tags: 
      - api
  service started: 
    doc: |-
    ...
    meta: 
      owner: platform
    origin: "tracing-wide tracing-wide/examples/catalogue-facet.rs:28:8"
    tags: 
      - platform
      - startup
tags: 
